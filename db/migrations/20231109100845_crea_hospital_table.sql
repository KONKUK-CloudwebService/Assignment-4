...
(
    ...
    is_open_24_hours  BOOLEAN NOT NULL DEFAULT 0, -- 24시간 운영 : 1(true), 폐업 or 말소 : 0(false)
    latitude          DECIMAL(10, 8) NOT NULL,    -- 병원 위치_위도 저장
    longitude         DECIMAL(11, 8) NOT NULL,    -- 병원 위치_경도 저장
